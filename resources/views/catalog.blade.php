    ...
    <div class="inner-page catalog-page">
        ...
        <div class="categories-wrapper centered-block mobile_wrap">
            <div class="categories-list">
                ...
                <a class="categories-list-item" href="{{route('category', ['id'=> $cat->id])}}">
                    <div class="categories-list-item-img">
                        <img src="{{asset('storage/' . $cat->images)}}" alt="Межкомнатные двери">
                    </div>
                    <div class="categories-list-item-content">
                        <div class="categories-list-item-name">{{$cat->name}}</div>
                    </div>
                </a>
                @endforeach
            </div>
